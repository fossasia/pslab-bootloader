...
Repository for the PSLab Bootloader for performing experiments with the [Pocket Science Lab](https://pslab.io) open-hardware platform.

[![Build Status](https://travis-ci.org/fossasia/pslab-bootloader.svg?branch=development)](https://travis-ci.org/fossasia/pslab-bootloader)
...
## Roadmap
 - [ ] Basic version of bootloader
 - [ ] Add device and start up options
 
## Screenshots

to be added

## How to set up the bootloader in your development environment
